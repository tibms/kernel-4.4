...
#define BQ25790_HIZ_EN		BIT(2)
#define BQ25790_CHRG_EN		BIT(5)
#define BQ25790_ADC_EN		BIT(7)
#define BQ25790_VAC_OVP_MASK	GENMASK(5, 4)
#define BQ25790_VAC_OVP_SHIFT	4
#define BQ25790_VRECHARGE_MASK	GENMASK(3, 0)

#define BQ25790_VRECHRG_STEP_mV		50
#define BQ25790_VRECHRG_OFFSET_mV		50
...
#define BQ25790_PRECHRG_VOLT_SHIFT		6
#define BQ25790_PRECHRG_VOLT_MASK		GENMASK(7, 6)
...
#define BQ25790_TERMCHRG_I_DEF_uA		200000//400000 for dual CP
